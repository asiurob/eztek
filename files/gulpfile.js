 ...
 * 3. Install theme packages: npm install --save-dev gulp@3.9.1
...
var targetPluginsDir = 'assets/plugins/plugin-css';
var pageAssetsPath = 'page-assets-lists';
var JSSource = JSDir + '/src';
var JSSourceFiles = [
  JSSource + '/start.js',
  JSSource + '/setup.js',
  JSSource + '/utils.js',
...
gulp.task('watch', function() {  
  ...
  gulp.watch(JSDir + '/src/**/*.js', ['compile-js']);
});
